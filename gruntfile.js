...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            clientCoffeeScript: {
                ...
                tasks: ['loadConfig', 'lint', 'copy', 'shell:compileCoffee', 'ngAnnotate', 'uglify'],
                options: {
                    livereload: true
                }
            },
        ...
        shell: {
            ...
            start: {
                command: 'npm start' //todo: there could be a smarter way
            }
        },
        copy: {
            statics: {
    ...
    // Default task
    grunt.registerTask('default', ['shell:clear', 'loadConfig', 'lint', 'copy', 'shell:compileCoffee', 'ngAnnotate', 'uglify', 'cssmin', 'concurrent:default']);
